...
var ngSanitize = require("ng-sanitize")
...
emojiApp.config(["$sceProvider", function(a) {
        ...
        $.emojiarea.spritesheetPath = "/dist/images/emojisprite_!.png", $.emojiarea.spritesheetDimens = Config.EmojiCategorySpritesheetDimens, $.emojiarea.iconSize = 20, $.emojiarea.icons = i, $.emojiarea.reverseIcons = j
        ...
        function e(b, e, f) {
            // modification to include delay
            // to prevent from not catching
            // contentEditable div
            a(function() {
              ...
              function j(a) {
                  ...
                  } else if (d && !d.match(/images\/blank\.gif/)) {
              ...
              $(p).on("keydown", function(c) {
                  if (q && i(), 13 == c.keyCode) {
                      ...
                      if(!b.emojiMessage.replyToUser) {
                        b.emojiMessage.replyToUser = function() {};
                      }
                      if (t && !c.shiftKey ? d = !0 : t || !c.ctrlKey && !c.metaKey || (d = !0), d) return a.cancel(s), h(), b.emojiMessage.replyToUser(), g()
                  }
              });
              ...
              b.$on("$destroy", function() {
                  // if(submitBtn != undefined) { $(submitBtn).off("mousedown"); }
                  $(document).off("paste", k), $(document).off("keydown", l), n.off("change"), q && $(q).off("DOMNodeInserted keyup", j), $(p).off("keydown")
              })
            }, 0);
        }
        return {
    ...
    }]), emojiApp.directive("contenteditable", ["$sce", "$filter", "$timeout", function(a, f, $timeout) {
        return {
            restrict: "A",
            require: "?ngModel",
            link: function(a, b, c, d) {
    ...
    function(a, b, c) {
        ...
        k.prototype.setup = function() {
            ...
            return o += "width:" + i + "px;", o += "height:" + i + "px;", o += "background:url('" + h.replace("!", d) + "') " + k + "px " + l + "px no-repeat;", o += "background-size:" + m + "px " + n + "px;", '<img src="/dist/images/blank.gif" class="img" style="' + o + '" alt="' + j.htmlEntities(g) + '">'
        ...
        var n = function(btn) {
            $('.emoji-menu').remove();
            var pos = (btn.data('position')) ? btn.data('position'): "bottom";
            var d = this,
                e = a(c.body),
                f = a(b),
                btnPar = btn.parent();
            this.visible = !1, this.emojiarea = null, this.$menu = a("<div>"), this.$menu.addClass("emoji-menu"), this.$menu.addClass(pos), this.$menu.hide(), this.$itemsTailWrap = a('<div class="emoji-items-wrap1"></div>').appendTo(this.$menu), this.$categoryTabs = a('<table class="emoji-menu-tabs"><tr><td><a class="emoji-menu-tab icon-recent" ></a></td><td><a class="emoji-menu-tab icon-smile" ></a></td><td><a class="emoji-menu-tab icon-flower"></a></td><td><a class="emoji-menu-tab icon-bell"></a></td><td><a class="emoji-menu-tab icon-car"></a></td><td><a class="emoji-menu-tab icon-grid"></a></td></tr></table>').appendTo(this.$itemsTailWrap), this.$itemsWrap = a('<div class="emoji-items-wrap nano mobile_scrollable_wrap"></div>').appendTo(this.$itemsTailWrap), this.$items = a('<div class="emoji-items nano-content">').appendTo(this.$itemsWrap), btnPar.append(this.$menu), Config.Mobile || this.$itemsWrap.nanoScroller({
        ...
        n.prototype.getTabIndex = function(a) {
            ...
            var a = null;
            return function(b, btn) {
                // console.log(btn);
                a = new n(btn), a.show(b)
            }
        }()
